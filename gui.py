...
def create_gui():
    ...
    input_folder_entry = ttk.Entry(root, width=40)
    input_folder_entry.grid(row=0, column=1, padx=5, pady=5)
    input_folder_button = ttk.Button(root, text="Choose Folder", command=lambda: choose_input_folder(input_folder_entry))
    ...
    output_folder_entry = ttk.Entry(root, width=40)
    output_folder_entry.grid(row=1, column=1, padx=5, pady=5)
    output_folder_button = ttk.Button(root, text="Choose Folder", command=lambda: choose_output_folder(output_folder_entry))
    ...
    convert_button = ttk.Button(root, text="Convert", command=lambda: [convert_button_click(
